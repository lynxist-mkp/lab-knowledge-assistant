...
- List issues: `gh issue list --repo lynxist-mkp/lab-knowledge-assistant ...`
- Comment: `gh issue comment <number> --repo lynxist-mkp/lab-knowledge-assistant --body "..."`
- Add or remove labels: `gh issue edit <number> --repo lynxist-mkp/lab-knowledge-assistant --add-label "..."` / `--remove-label "..."`
- Close: `gh issue close <number> --repo lynxist-mkp/lab-knowledge-assistant --comment "..."`
...
4. Blocking: prefer native issue dependencies. Use the blocker's database id from `gh api repos/lynxist-mkp/lab-knowledge-assistant/issues/<n> --jq .id`, then post the dependency edge. If dependencies are unavailable, fall back to a `Blocked by: #<n>` line in the child body.
...
6. Claim: `gh issue edit <n> --repo lynxist-mkp/lab-knowledge-assistant --add-assignee @me`
