...
from lab_knowledge.tracing.stage_result import normalize_query_stages
from lab_knowledge.tracing.steps import QUERY_LABELS, QUERY_STAGE_ORDER, stage_label
...
def build_query_trace_summary(record: dict[str, Any]) -> QueryTraceSummary:
...
def build_query_trace_detail(record: dict[str, Any]) -> QueryTraceDetail:
    return QueryTraceDetail(
        summary=build_query_trace_summary(record),
