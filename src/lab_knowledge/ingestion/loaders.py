...
from lab_knowledge.components.paddleocr import (
    build_text_from_ocr_payload,
    parse_scanned_pdf,
)
from lab_knowledge.config import Settings
from lab_knowledge.ingestion.pdf_route import choose_pdf_route, validate_pdf_load_mode
from lab_knowledge.ingestion.source_metadata import extract_pdf_embedded_metadata
