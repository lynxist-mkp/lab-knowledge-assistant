...
from lab_knowledge.knowledge.browse import ChunkDetail, CultureDomainGroup, chunk_detail_from_chunk
from lab_knowledge.knowledge.document_card import DocumentCard, DocumentNotFoundError
from lab_knowledge.knowledge.domain import is_searchable, summary, tags
...
class ReadPath:
    ...
    def list_pending_review_documents(self) -> list[PendingReviewDocument]:
        from lab_knowledge.knowledge.review import list_pending_from_catalog
