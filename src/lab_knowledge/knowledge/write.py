...
from lab_knowledge.knowledge.domain import REVIEW_APPROVED, REVIEW_STATUS_FIELD, stamp_review_status
from lab_knowledge.models import Chunk
from lab_knowledge.storage.fingerprints import FingerprintRecord
...
if TYPE_CHECKING:
    ...
    from lab_knowledge.knowledge.store import IngestStatus, PrepareResult, UpsertResult
...
class WritePath:
    ...
    def plan_document(
        ...
        *,
        ...
        from lab_knowledge.knowledge.store import PrepareResult
    ...
    def _upsert_chunks(self, chunks: list[Chunk]) -> UpsertResult:
        from lab_knowledge.knowledge.store import UpsertResult
