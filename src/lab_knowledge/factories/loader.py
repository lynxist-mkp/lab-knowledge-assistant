...
_COMPONENT_PACKAGES = (
    "lab_knowledge.components.embedding",
    "lab_knowledge.components.evaluator",
    "lab_knowledge.components.multimodal",
    "lab_knowledge.components.reranker",
    "lab_knowledge.components.splitter",
    "lab_knowledge.components.transform",
    "lab_knowledge.components.vector_store",
)
