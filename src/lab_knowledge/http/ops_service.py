...
from lab_knowledge.tracing.ingestion_views import StageDegradation
...
class OpsService:
    ...
    def approve_review(
        ...
        self._document_management.approve_review(document_id, collection_id=collection_id)

    def reject_review(self, document_id: str, *, collection_id: str | None = None) -> None:
        self._document_management.reject_review(document_id, collection_id=collection_id)
